  ...
  <div class="columns is-multiline">
    ...
    <div class="column is-8 is-offset-1 box">
      <div class="columns is-multiline form">
        ...
        <div class="column is-half">
          ...
          <b-field label="Product Name">
              <b-input v-model="form.productName" placeholder="Product name"></b-input>
          </b-field>

          <b-field label="Product Description">
              <b-input v-model="form.productDescription"
              maxlength="300"
              type="textarea" placeholder="Description Here"></b-input>
          </b-field>
        ...
        <div class="column">
          <b-field label="Product Price" expanded>
            <b-field>
              ...
              <b-input placeholder="0,00" type="number" v-model="form.price" expanded></b-input>
            </b-field>
          </b-field>

          <b-field label="Product Quantity">
            <b-numberinput v-model="form.quantity"></b-numberinput>
          </b-field>
      ...
      <b-button
        ...
        icon-pack="fas"
        icon-left="plus"
        @click.prevent="updateProduct(id)"
      ...
      axios({
        ...
        .then(({ data }) => {
          ...
          this.$notification.open({
            duration: 2000,
            message: `Product ${this.form.productName} Has Been Updated`,
            position: 'is-top-right',
            type: 'is-info',
            hasIcon: true,
          });
          this.$store.commit('loadingOn');
          this.$emit('switchsection', 'all');
        })
        .catch((err) => {
          this.$notification.open({
            duration: 3000,
